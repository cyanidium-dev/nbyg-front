...
export default function Notification({
    ...
    return (
        <Modal
            ...
            className="rounded-[12px] min-w-[328px]"
        >
            <div className="p-4 pt-14 md:p-6 md:pt-14 lg:p-10 relative flex flex-col justify-center items-center w-full max-w-[560px] z-20">
